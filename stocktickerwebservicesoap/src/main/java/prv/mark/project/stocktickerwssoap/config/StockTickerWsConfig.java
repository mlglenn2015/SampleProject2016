package prv.mark.project.stocktickerwssoap.config;
 ...
 */
@Configuration
@ComponentScan("prv.mark.project.stocktickerwssoap")
...
public class StockTickerWsConfig extends WsConfigurerAdapter {
    ...
    public SimpleWsdl11Definition stockTicker() {
        return new SimpleWsdl11Definition(new ClassPathResource("StockQuote.wsdl"));
    }
