...
public final class NumberUtils extends org.apache.commons.lang3.math.NumberUtils {
     ...
     */
    public static BigDecimal myToBigDecimal(final Double value) {
        if (value == null) {
     ...
     * @return {@link BigDecimal}
     */
    public static BigDecimal myToBigDecimal(final Float value) {
        if (value == null) {
            return new BigDecimal(0.00);
        }
     ...
     * @return {@link BigDecimal}
     */
    public static BigDecimal myToBigDecimal(final Long value) {
        if (value == null) {
            return new BigDecimal(0.00);
        }
        BigDecimal returnVal = new BigDecimal(value).setScale(12, BigDecimal.ROUND_HALF_UP);
     ...
     * @return {@link BigDecimal}
     */
    public static BigDecimal myToBigDecimal(final Integer value) {
        if (value == null) {
            return new BigDecimal(0.00);
        }
        BigDecimal returnVal = new BigDecimal(value).setScale(12, BigDecimal.ROUND_HALF_UP);
     ...
     */
    public static int myToInt(final String str) {
     ...
     */
    public static long myToLong(final String str) {
     ...
     * @return {@link Long}
     */
    public static long myToLong(final Integer intValue) {
        if (intValue == null) {
            return 0L;
        }
