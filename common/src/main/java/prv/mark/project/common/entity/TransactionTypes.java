...
public class TransactionTypes implements Serializable {
    ...
    @SequenceGenerator(
            name = "SEQ_TRANSACTION_TYPES_ID", sequenceName = "SEQ_TRANSACTION_TYPES_ID", initialValue = 1, allocationSize = 1)
    @GeneratedValue(generator = "SEQ_TRANSACTION_TYPES_ID", strategy = GenerationType.SEQUENCE)
    private Long id;
