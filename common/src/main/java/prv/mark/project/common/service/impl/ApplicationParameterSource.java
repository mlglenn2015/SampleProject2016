...
public final class ApplicationParameterSource {
    ...
    public String getParm(final String propKey) throws ApplicationException {
        ...
        //ApplicationParameterEntity parameter = applicationParameterRepository.findActiveByPropKey(propKey);
        ApplicationParameterEntity parameter = applicationParameterRepository.findEnabledByParameterKey(propKey, true);
        if (parameter == null) {
