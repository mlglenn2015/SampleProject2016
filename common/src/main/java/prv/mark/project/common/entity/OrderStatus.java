...
public class OrderStatus implements Serializable {
    ...
    @SequenceGenerator(
            name = "SEQ_ORDER_STATUS_ID", sequenceName = "SEQ_ORDER_STATUS_ID", initialValue = 1, allocationSize = 1)
    @GeneratedValue(generator = "SEQ_ORDER_STATUS_ID", strategy = GenerationType.SEQUENCE)
    private Long id;
