...
:usage
	...
	echo for example:
	echo %1 managedserver1 http://DELL-I5:7001
GOTO :EOF
...
set JAVA_OPTIONS=-Xms512m -Xmx1024m -Dspring.profiles.active=dev -DLOG_LOCATION=/etc/log -DENVIRONMENT=dev -Dapp.jpa.logging=SEVERE
@REM *************************************************************************
